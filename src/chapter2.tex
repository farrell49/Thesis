...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.7\linewidth]{fig/kennedy_rolling_TODO}
   \caption{TODO Create a picture of the rolling contact for Kennedy theorem}
...
These results are shown in Table \ref{table:single_slide_estimate}.
